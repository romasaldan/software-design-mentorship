...
describe('Weapon', () => {
  ...
  it('to string implementation', () => {
    ...
    expect(String(weapon)).toBe('hammer - Value: 300, Weight: 2.03, Damage: 30.47, Durability: 83.93%')
  })
  ...
  it('use should return action description', () => {
    ...
    expect(weapon.use()).toBe('You use the hammer, dealing 30.47 points of damage.')
  })
  ...
  it('use should return that weapon is broken after using', () => {
    ...
    expect(weapon.use()).toBe('You use the hammer, dealing 30.42 points of damage. The hammer breaks.')
  })
